...
<div><span style="font-size:16px;"><strong>Username:</strong> ${info.username}</span><br><span style="font-size:16px;"><strong>Password:</strong> ${info.password}</span></div>
...
<div>&nbsp;</div>
    ...
    async sendEmail(to, subject, email) {
        let info = await this.transporter.sendMail({
            from: '"Auxy System" <auxy.system@gmail.com>', // sender address
            to: to, // list of receivers
            subject: subject, // Subject line
            html: email // html body
        });

        return {id: info.messageId, preview: nodemailer.getTestMessageUrl(info)}
    }
}
